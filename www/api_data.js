define({ "api": [
  {
    ...
    "description": "<p>Deletes an existing Composition by ID. To be deleted it doesn't have to be used as dependency in another Composition. Soft deleting (set &quot;enabled&quot; to false).</p>",
    "success": {
      "examples": [
        {
          "title": "Response",
  ...
  {
    "type": "topic",
    "url": "composition.created",
    "title": "composition.created",
    "name": "CompositionCreated",
    "group": "RabbitMQ",
    "description": "<p>Emits a new event when a new composition is created</p>",
    "success": {
      "examples": [
        {
          "title": "Body",
    ...
    "version": "0.0.0",
    "filename": "./composition/service.go",
    "groupTitle": "RabbitMQ"
  },
  {
    "type": "topic",
    "url": "composition.deleted",
    "title": "composition.deleted",
    "name": "CompositionDeleted",
    "group": "RabbitMQ",
    "description": "<p>Emits a new event when an existing composition is deleted.</p>",
    "success": {
      "examples": [
        {
          "title": "Body",
  ...
  {
    "type": "topic",
    "url": "composition.updated",
    "title": "composition.updated",
    "name": "CompositionUpdatedAutomatically",
    "group": "RabbitMQ",
    "description": "<p>Emits a new event when an existing composition is updated. This event can be of type &quot;CompositionUpdatedManually&quot; or &quot;CompositionUpdatedAutomatically&quot;. The last one is published once a composition is updated due to a dependency change.</p>",
    "success": {
      "examples": [
        {
          "title": "Body",
  ...
  },
  {
    ...
    "url": "composition.updated",
    "title": "composition.updated",
    "name": "CompositionUpdatedManually",
    "group": "RabbitMQ",
    "description": "<p>Emits a new event when an existing composition is updated. This event can be of type &quot;CompositionUpdatedManually&quot; or &quot;CompositionUpdatedAutomatically&quot;. The last one is published once a composition is updated due to a dependency change.</p>",
    "success": {
      "examples": [
